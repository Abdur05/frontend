...
@Component({
  selector: 'app-add-appraisal-cycle',
  templateUrl: './add-appraisal-cycle.component.html',
  styleUrls: ['./add-appraisal-cycle.component.css']
})
export class AddAppraisalCycleComponent {
  ...
  todayDate: any = [new Date(), new Date()]
  bsValueRange: any = []
  ...
  createFormFields() {
    this.skillFormGroup = this.fb.group({
      ...
      dates: [''],
      appraisalCyclePeriodStart: ['', [Validators.required]],
      ...
      appraisalProcessConfigurationDetails: this.fb.group({
        ...
        selfAppraisal: [''],
        selfAppraisalPeriod: [''],
        selfAppraisalPeriodStart: [''],
        selfAppraisalPeriodEnd: [''],
        reviewPeriod: [''],
        reviewPeriodStart: [''],
        reviewPeriodEnd: [''],
        salaryHike: ['N'],
        normalizationPeriod: [''],
        normalizationPeriodStart: [''],
        normalizationPeriodEnd: ['']
      }),
  ...
  async submitData() {
    try {
      ...
      const result: any = await this.appraisalCycleSer.createAppraisalCycleDetail(this.skillFormGroup.value)
  ...
  onCheckboxChange(event: any) {
    ...
    const maxLimitControl = this.skillFormGroup.get('appraisalProcessConfigurationDetails.selfAppraisalPeriod');
    if (isChecked) {
