...
@Component({
  selector: 'app-edit-assement-courses-level',
  templateUrl: './edit-assement-courses-level.component.html',
  styleUrls: ['./edit-assement-courses-level.component.css']
})
export class EditAssementCoursesLevelComponent {
