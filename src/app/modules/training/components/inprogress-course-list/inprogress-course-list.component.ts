...
@Component({
  selector: 'app-inprogress-course-list',
  templateUrl: './inprogress-course-list.component.html',
  styleUrls: ['./inprogress-course-list.component.css']
})
export class InprogressCourseListComponent {
