...
import { ViewAssessmentAttemptListComponent } from '../assessement/view-assessment-attempt-list/view-assessment-attempt-list.component';
...
export class ViewCourseContentComponent {
  ...
  viewAttemptDetails(data?: any) {
    const dialogRef = this.dialogBox.open(ViewAssessmentAttemptListComponent, {
      data: data,
      width: '1000px',
      height: '1000px',
      autoFocus: false
